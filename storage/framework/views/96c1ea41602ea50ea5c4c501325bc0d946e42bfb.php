        ...
        <div class="animated fadeIn">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body card-block">
                    ...
                    <a class="btn btn-primary" href="<?php echo e(url('tambahArtikel')); ?>" role="button"> + Tambah Artikel </a>
                    ...
                    <table id="tabelArtikel" class="table bordered" style="margin-top: 20px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/artikel/edit/<?php echo e($data->id); ?>" class="btn btn-primary btn-sm">
